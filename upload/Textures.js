...
window.onload = function init()
{
	...
	document.getElementById("btn_earthTexture").onclick = function(){
	...
	document.getElementById("btn_checkerboardTexture").onclick = function(){
        texture0 = CreateTexture('cbtexture.png',
        function(texture, image)
        {
            gl.bindTexture(gl.TEXTURE_2D, texture);
            gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, image);
	...
	document.getElementById("btn_lavaTexture").onclick = function(){
        texture0 = CreateTexture('lava.jpg',
        function(texture, image)
        {
            gl.bindTexture(gl.TEXTURE_2D, texture);
            gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, image);
